...
namespace SSI.Utilities
{
    ...
    public class ImageHelper
    {
        ...
        public static void CutForSquare(Stream fromFile, string fileSaveUrl, int side, int quality = 75)
        {
            //创建目录
            ...
            else
            {
                ...
                foreach (ImageCodecInfo i in icis)
                {
                    ...
                    //错误修正 阮创  By 阮创 2017/11/30
                    if (i.FormatID == resultImage.RawFormat.Guid)
                    {
                        ici = i;
                        break;
                    }
        ...
        /// <param name="quality">质量（范围0-100）</param>
        public static void CutForCustom(Stream fromFile, string fileSaveUrl, int maxWidth, int maxHeight, int quality = 75)
        {
        ...
        public static void ZoomAuto(Stream fromFile, string savePath, double targetWidth, double targetHeight, string watermarkText=null, string watermarkImage=null)
        {
            //创建目录
