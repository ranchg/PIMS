...
namespace SSI.Repository
{
    public interface IRepository<T> where T : new()
    {
        ...
        /// <returns></returns>
        List<T> FindListPage(ref GridParam gp);
        ...
        /// <param name="jqgridparam">分页参数</param>
        /// <returns></returns>
        List<T> FindListPage(string WhereSql, DbParameter[] parameters, ref GridParam gp);
        ...
        /// <param name="jqgridparam">分页参数</param>
        /// <returns></returns>
        List<T> FindListPageBySql(string strSql, ref GridParam gp);
        ...
        DataTable FindTable(List<string> queryField);
        DataTable FindTable(List<string> queryField, string WhereSql, DbParameter[] parameters);
        /// <summary>
        /// 查询数据列表、返回 DataTable
        /// </summary>
        /// <param name="strSql">Sql语句</param>
        ...
        /// <param name="jqgridparam">分页参数</param>
        /// <returns></returns>
        DataTable FindTablePageBySql(string strSql, ref GridParam gp);
